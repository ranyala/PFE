...
public class FoncController {
    ...
    public ResponseEntity<?> getDataAdmFoncWs(HttpServletRequest request, @RequestBody SearchObject obj) {
        try {
            ...
            return sendWsService.sendResult(request, commonService.getListPaginator(obj, new AdmFonc(), null));
        } catch (Exception argEx) {
            logger.error("Error AdmFoncController in method getDataAdmFoncWs :: " + argEx.toString());
    ...
    public SendObject deleteById(HttpServletRequest request, @RequestParam("idFonction") Long idFonction) {
        try {
            ...
            logger.error("Error AdmFoncController in method deleteDataAdmFoncWs :: " + argEx.toString());
            return null;
        }
    }
    ...
    public ResponseEntity<?> addFonction(HttpServletRequest request,@RequestBody AdmFonc entity) {
        try {
    ...
    public ResponseEntity<?> editFonction(HttpServletRequest request, @RequestBody AdmFonc entity) {
        try {
            return sendWsService.sendResult(request, fonctionService.saveOrUpdateFonction(entity));
        } catch (Exception argEx) {
    ...
    public ResponseEntity<?> exportDataWs(HttpServletRequest request, @RequestBody SearchObject obj) {
        try {
            return sendWsService.downloadFile(request, commonService.exportDataWs(obj, new AdmFonc(), null));
        } catch (Exception argEx) {
