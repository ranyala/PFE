...
import tn.com.st2i.project.administration.model.LogAccess ;
...
public class VLogAccessController {
    ...
    public ResponseEntity<?> getDataVLogAccessWs(HttpServletRequest request, @RequestBody SearchObject obj) {
        try {
            return sendWsService.sendResult(request, commonService.getListPaginator(obj, new LogAccess(), null));
        } catch (Exception argEx) {
    ...
    public ResponseEntity<?> exportDataWs(HttpServletRequest request, @RequestBody SearchObject obj) {
        try {
            return sendWsService.downloadFile(request, commonService.exportDataWs(obj, new LogAccess(), null));
        } catch (Exception argEx) {
