...
public class FoncService implements IFonctionService {
    ...
    private static final Logger logger = LogManager.getLogger(AdmFonc.class);

    @Autowired
    public IAdmFoncRepository foncRepo;
    ...
    @Override
    public SendObject saveOrUpdateFonction(AdmFonc entity) {
