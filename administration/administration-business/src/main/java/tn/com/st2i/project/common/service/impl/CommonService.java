...
import tn.com.st2i.project.tools.*;
...
//Creating font
			...
			Font fontt = new Font(Font.HELVETICA, 12, Font.ITALIC, Color.black);
			...
			Font TitleFont = new Font(Font.HELVETICA, 15, Font.BOLD, Color.black);
