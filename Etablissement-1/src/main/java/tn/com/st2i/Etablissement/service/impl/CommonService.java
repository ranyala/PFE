...
import tn.com.st2i.Etablissement.tools.*;
...
public class CommonService implements ICommonService {
    ...
    @Override
    public SendObject getListPaginator(SearchObject objX, Object objClass, String particularSpecifCondi) throws JSONException {
        try {
            ...
            CompletableFuture<DaoObject> cfL = CompletableFuture
                    .supplyAsync(() -> {
                        try {
                            return commonDao.getListPaginator(obj, objClass, particularSpecifCondi);
